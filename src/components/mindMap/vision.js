...
<div className="vision-content-pad">
      <MindSectionInfo
        img={<img src={General} alt="monkey1"/>}
        ...
        because we'll always have community as the #1 value of Meta Street Apes.
        "
        titleSmThree=" Dope Sh*t Only:"
        contentThree="Meta Street Apes are creative, brave, and relentless. It's easy to follow trends and 
        improve incrementally. It's harder to be original and do dope sh*t. We pave our own path.
"
